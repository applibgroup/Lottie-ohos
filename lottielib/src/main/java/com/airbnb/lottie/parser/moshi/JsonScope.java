...
final class JsonScope {
   ...
   * @param pathIndices contains the current index in array
   * @param pathNames pathNames contains the name at this scope.
   * @param stack int array
   * @param stackSize in int
   * @return Renders the path in a JSON document to a string
   */
