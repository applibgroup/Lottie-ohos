...
public class GradientColorParser implements ValueParser<GradientColor> {
     ...
     * @param array  list of type float
    ...
    private void addOpacityStopsToGradientIfNeeded(GradientColor gradientColor, List<Float> array) {
        ...
        for (int i = 0; i < gradientColor.getSize(); i++) {
            ...
            color = Color.argb(getOpacityAtPosition(gradientColor.getPositions()[i], positions, opacities),
                Utils.red(color), Utils.green(color), Utils.blue(color));
