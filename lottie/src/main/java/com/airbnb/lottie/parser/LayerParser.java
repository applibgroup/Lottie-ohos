...
public class LayerParser {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", // 0
        "ind", // 1
        "refId", // 2
        "ty", // 3
        "parent", // 4
    ...
    public static Layer parse(LottieComposition composition) {
        ...
        Layer layer = new Layer(Collections.<ContentModel>emptyList(), composition, "__container", -1,
            Layer.LayerType.PRE_COMP, -1, null, Collections.<Mask>emptyList(), new AnimatableTransform(), 0, 0, 0, 0, 0,
            bounds.getWidth(), bounds.getHeight(), null, null, Collections.<Keyframe<Float>>emptyList(),
