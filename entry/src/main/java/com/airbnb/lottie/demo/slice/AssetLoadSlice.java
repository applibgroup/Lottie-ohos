...
public class AssetLoadSlice extends AbilitySlice {
    ...
    private void initJson() {
        ...
        jsonData.add("ribbon_one.zip");
        jsonData.add("ribbon_two.zip");
        jsonData.add("star_none.zip");
        jsonData.add("star_one.zip");
        jsonData.add("star_two.zip");
        jsonData.add("star_three.zip");
        jsonData.add("light.zip");
        jsonData.add("switcher_left.zip");
        jsonData.add("switcher_right.zip");
    }
}
